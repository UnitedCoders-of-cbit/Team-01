...
$sql=mysqli_query($con,"update tblpatient set PatientName='$patname',PatientContno='$patcontact',PatientEmail='$patemail',PatientGender='$gender',PatientAdd='$pataddress',PatientAge='$patage',PatientMedhis='$medhis',prescription='$presc' where ID='$eid'");
if($sql)
{
echo "<script>alert('Patient info updated Successfully');</script>";
header('location:manage-patient.php');

$url = 'http://192.168.13.159:5000/';
...
<textarea type="text" name="presc" class="form-control"  placeholder="Prescribe Medication" required="true"><?php  echo $row['prescription'];?></textarea>
</div>	
<div class="form-group">
<label for="fess">
 Creation Date
